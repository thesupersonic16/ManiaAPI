...
#pragma region Enums
	...
	enum ObjectType
	{
		...
		ObjectType_MovingDust = 0x00AC6D18, //Mighty - Ground Pund.
...
#pragma region Entity
	...
	{
#pragma region Data
		/* 0x00000000 */ short emp; //16 bit bitshift (aka 8 is 0x80000 (or 8 << 16))
		/* 0x00000002 */ short XPos; //16 bit bitshift (aka 8 is 0x80000 (or 8 << 16))
		/* 0x00000004 */ short emp2; //16 bit bitshift (aka 8 is 0x80000 (or 8 << 16))
		/* 0x00000006 */ short YPos; //16 bit bitshift (aka 8 is 0x80000 (or 8 << 16))
